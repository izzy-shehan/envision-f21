...
const grapefruit = food_arr[0]
console.log(grapefruit) // whole object
console.log(grapefruit.foodGroup) // object property
...
paragraphs = paragraphs.data(food_arr)
console.log(paragraphs)
...
addText.text((d) => d.foodName)

// LOVE IT
// let's change the text color to correspond w the food color

addText.style('color', (d) => d.foodColor)
...
addText.text((d,i) => "#" + (i+1) + ": " + d.foodName + " is a " + d.foodGroup)
